...
dm.dea(df.toy.5[,1], df.toy.5[,2:3], rts = "vrs", orientation = "i")
dm.dea(df.toy.5[,2:3], df.toy.5[,4], rts = "vrs", orientation = "i")
dm.network.dea.pmsg(xdata.s1 = df.toy.5[,1], zdata = df.toy.5[,2:3], ydata.s2 = df.toy.5[,4], rts = "vrs", orientation = "i", leader = "1st")$eff.s2
dm.network.dea.pmsg(xdata.s1 = df.toy.5[,1], zdata = df.toy.5[,2:3], ydata.s2 = df.toy.5[,4], rts = "vrs", orientation = "i", leader = "1st", pm = T)$eff.s2
